    ...
    public WeatherResponse getWeatherData(double latitude, double longitude) {
            ...
            return weatherWebClient.get()
                    .uri(uriBuilder -> uriBuilder
                            ...
                            .queryParam("current", "temperature_2m,relative_humidity_2m,apparent_temperature,is_day,precipitation,cloud_cover")
                            .queryParam("daily", "apparent_temperature_min,precipitation_probability_max,apparent_temperature_max")
                            .queryParam("hourly", "temperature_2m,relative_humidity_2m,apparent_temperature,precipitation_probability")
