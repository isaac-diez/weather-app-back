    ...
    public WeatherResponse getWeatherData(double latitude, double longitude) {
            ...
            return weatherWebClient.get()
                    .uri(uriBuilder -> uriBuilder
                            ...
                            .queryParam("hourly", "temperature_2m,weather_code,rain,precipitation_probability,cloud_cover,uv_index,uv_index_clear_sky,sunshine_duration,shortwave_radiation,direct_radiation,diffuse_radiation")
                            .queryParam("daily", "temperature_2m_max,temperature_2m_min,apparent_temperature_max,apparent_temperature_min,precipitation_probability_max,uv_index_max,uv_index_clear_sky_max,sunshine_duration,daylight_duration")
