...
public class GeminiServiceImpl implements GeminiService {
    ...
    private String buildPrompt(String mode, CurrentWeatherDTO weather, String cityName) {
        ...
        switch (mode) {
            case "outfit":
                return promptBase + "Act as a fashion stylist. Recommend a brief outfit using emojis giving the reason why in no more than 2 paragraphs. Do not indicate word count. Do not use markdown";
            case "activity":
                return promptBase + "Act as a local guide. Recommend 2 brief activities right now using emojis. If you can't find anything interesting, suggest a plan for the nearest major city. Do not indicate word count. Do not use markdown";
            case "laundry":
                return promptBase + "Act as a Home expert. Is it a good time to do laundry and hang clothes outside? Explain why in 1 short, funny sentence. Do not indicate word count. Do not use markdown";
            case "drink":
                return promptBase + "Act as a Bar Expert. Recommend an ideal drink in the ideal bar or cafeteria for this weather and whether drink it at the bar or on the terrace. Indicate why. Do not indicate word count. Do not use markdown";
            default:
